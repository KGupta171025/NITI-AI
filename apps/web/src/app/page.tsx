...
function FeatureCard({
  ...
  return (
    <div className="glass-card rounded-2xl p-6 group hover:border-brand-500/30 transition-colors duration-300 animate-fade-in">
    ...
    <div className="min-h-dvh bg-slate-950 text-slate-100 flex flex-col relative overflow-x-hidden">
      ...
      <main className="flex-1 relative z-10">
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 text-center">
          ...
          {/* Headline */}
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-50 leading-[1.1] tracking-tight mb-6">
          ...
          {/* Multilingual hint */}
          <p className="mt-6 text-slate-500 text-sm font-hindi">
